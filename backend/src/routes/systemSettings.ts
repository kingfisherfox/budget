...
systemSettingsRouter.get("/", async (_req: Request, res: Response, next: NextFunction) => {
  try {
...
systemSettingsRouter.put("/", requireAuth, async (req: Request, res: Response, next: NextFunction) => {
  try {
